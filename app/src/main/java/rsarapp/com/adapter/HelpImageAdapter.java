...
public class HelpImageAdapter extends PagerAdapter {
    ...
    private final ArrayList<BannerModel.BannerDatum> imageModelArrayList;
    private final LayoutInflater inflater;
    private final Context context;

    public HelpImageAdapter(Context context, ArrayList<BannerModel.BannerDatum> imageModelArrayList) {

...
public class TestGridAdapter extends RecyclerView.Adapter<TestGridAdapter.ViewHolder> {
    private final List<TestResponseModel.Datum> listdata;
    private final Context context;

    public TestGridAdapter(List<TestResponseModel.Datum> listdata, Context context) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TestGridAdapter.ViewHolder holder, int position) {

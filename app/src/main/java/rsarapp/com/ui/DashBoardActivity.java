...
import rsarapp.com.rsarapp.BookListActivity;
import rsarapp.com.rsarapp.R;
import rsarapp.com.rsarapp.SubjectActivity;
...
public class DashBoardActivity extends AppCompatActivity {
    ...
    String Pref_Bg_Code, Pref_Top_Bg_Code, Pref_Button_Bg, Pref_School_UI, Pref_School_name, Pref_Restric_Id, Pref_UserType, Pref_Email, Pref_Mob;
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                if (Str_Status.equalsIgnoreCase("True")) {
                                    ...
                                    for (int j = 0; j < Class_Data.length(); j++) {
                                        ...
                                        GridViewAdapterChap adapter = new GridViewAdapterChap(context, vinsquesarrayList);

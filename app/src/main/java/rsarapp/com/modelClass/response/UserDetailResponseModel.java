...
public class UserDetailResponseModel {
    ...
    public UserDetailResponseModel(String status, String userType, String classId, String access, String action, String otp, String oTPPopup, String email, String mobile, String schoolName, String schoolFolderName, String bgCode, String topBgCode, String buttonBgColor, String schoolNameColor, String folderName, String schoolFolderPath, String message, String activationStatus, String registeredUserId, String deviceId, String restrictSD, String schoolUI) {
        this.status = status;
